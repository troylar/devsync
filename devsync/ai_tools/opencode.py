...
class OpenCodeTool(AITool):
    ...
    OpenCode reads a single AGENTS.md file at the project root.
    ...
    def get_project_instructions_directory(self, project_root: Path) -> Path:
        """Get the directory for project-specific OpenCode instructions.
